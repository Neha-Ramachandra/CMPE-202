...
public class Parking {
	...
	public static void writeCsvFile() {
		...
		ParkingModel parking1 = new ParkingModel(1, "San Jose", 'V', 5, System.currentTimeMillis(),  System.currentTimeMillis()+10000000, 10);
...
//		parkingOfAllLocations.add(parking4);
		...
		try {
			...
			fileWriter = new FileWriter("C:\\Users\\neha\\Desktop\\parkingDetailsFile.csv", true);
		...
		try {
			...
			for (int j = 0; j < vacantSlots.length; j++) {
				for (int k = 0; k < vacantSlots.length; k++) {
					if (slotStatus[k].equals(Character.toString('V'))) {
